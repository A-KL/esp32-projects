...
public:
  MainForm(const UIRect& rect) : 
        ...
        levelLeft({ 24, 181,           246, 15 }, 0, 32767, 32767 * 0.95, 0),
        levelRight({ 24, 181 + 15 + 3, 246, 15 }, 0, 32767, 32767 * 0.95, 0),

        header({ 0, 0, 320, 20 }),
        footer({ 0, 240-18, 320, 18 }),

        leftTextL({ 0, 181, 20, 15 }, "L"),
        rightTextL({ 0, 181 + 13 + 3, 20, 15 }, "R"),

        leftTextValue({ 24 + 246 + 10, 181, 25, 15 }, "1.0"),
        rightTextValue({ 24 + 246 + 10, 181 + 13 + 3, 25, 15 }, "1.0")
    { 
        header.Add(track);
        header.Add(volume); 
