...
static Arduino_GFX *g = new Arduino_AXS15231B(bus, TFT_RST, 0, false, TFT_WIDTH, TFT_HEIGHT);
static Arduino_Canvas *gfx = new Arduino_Canvas(TFT_WIDTH, TFT_HEIGHT, g, 0, 0, 1);
...
void lv_lcd_flush_cb(lv_disp_drv_t *drv, const lv_area_t *area, lv_color_t *color_p)
{
  ...
  g->draw16bitRGBBitmap(area->x1, area->y1, (uint16_t *)color_p, w, h);
...
void lv_lcd_init()
{
  ...
  gfx->drawRoundRect(10, 10, gfx->width() - 20, gfx->height() - 20, 20, RGB565_RED);
